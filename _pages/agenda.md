...
<div style="display: flex; flex-wrap: wrap; gap: 24px; margin-top: 20px; margin-bottom: 40px;">
  ...
  <div style="width: 160px; text-align: center;">
    <img src="{{ '/assets/images/mb.jpg' | relative_url }}" alt="Eric Deutsch" style="width: 140px; height: 140px; object-fit: cover; border-radius: 50%; display: block; margin: 0 auto 10px auto;" />
    <div style="font-size: 0.9rem; line-height: 1.3;">
  ...
  <div style="width: 160px; text-align: center;">
    <img src="{{ '/assets/images/mb.jpg' | relative_url }}" alt="Wu Wei" style="width: 140px; height: 140px; object-fit: cover; border-radius: 50%; display: block; margin: 0 auto 10px auto;" />
    <div style="font-size: 0.9rem; line-height: 1.3;">
  ...
  <div style="width: 160px; text-align: center;">
    <img src="{{ '/assets/images/mb.jpg' | relative_url }}" alt="Yardena Samuels" style="width: 140px; height: 140px; object-fit: cover; border-radius: 50%; display: block; margin: 0 auto 10px auto;" />
    <div style="font-size: 0.9rem; line-height: 1.3;">
  ...
  <div style="width: 160px; text-align: center;">
    <img src="{{ '/assets/images/mb.jpg' | relative_url }}" alt="Michal Bassani-Sternberg" style="width: 140px; height: 140px; object-fit: cover; border-radius: 50%; display: block; margin: 0 auto 10px auto;" />
    <div style="font-size: 0.9rem; line-height: 1.3;">
